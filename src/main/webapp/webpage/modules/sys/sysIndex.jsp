...
<head>
    ...
    <title>Dynobike</title>

	<%@ include file="/webpage/include/head.jsp"%>
	<script src="${ctxStatic}/common/inspinia.js?v=3.2.0"></script>
	<script src="${ctxStatic}/common/contabs.js"></script> 
    <meta name="keywords" content="Dynobike 管理平台">
    <meta name="description" content="Dynobike，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的管理平台">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="http://www.usingwin.cn">http://www.usingwin.cn</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
