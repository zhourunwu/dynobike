					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<br/>
									<img src="${ctxStatic }/common/login/images/lucencylogo.png" style="width:280px">
									<br>
								</h1>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; www.usingwin.cn</font></h4></div>
