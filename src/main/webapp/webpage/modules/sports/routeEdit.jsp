       ...
       var $ = jQuery,
			...
			//	初始化Web Uploader
	 		uploader = WebUploader.create({
    			...
    			// 文件接收服务端。
    			server: 'http://localhost:9090/dynobike/a/sports/route/uploadImage.json',
...
<div id="global">
<form:form commandName="routetoedit" action="${ctx}/sports/route/RouteUpdate" method="post">
    <fieldset>
        <legend>Route Basic Info</legend>
        <form:hidden path="route_id" />
        <form:hidden path="create_time" />
        <form:hidden path="route_photo_id" />
        ...
        <div id="buttons" style="display: block; float:right; margin-right: 5px; ">
            ...
            <input id="submit" type="submit" tabindex="5" class="btn btn-primary" value="Save Route">
        </div>
